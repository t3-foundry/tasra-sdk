...
export const nodeRegistryAbi = [
    ...
    "outputs": [
      {
        "name": "page",
        "type": "tuple[]",
        "internalType": "struct NodeRegistry.OperatorView[]",
        "components": [
          {
            "name": "operator",
            "type": "address",
  ...
  {
    "type": "function",
    "name": "requireRegisterCommitReveal",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "function",
    "name": "setRequireRegisterCommitReveal",
    "inputs": [
      {
        "name": "required",
        "type": "bool",
  ...
  {
    "type": "function",
    "name": "taggedActiveOperatorsPage",
    "inputs": [
      {
        "name": "tag",
        "type": "bytes32",
